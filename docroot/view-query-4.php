...
if($result = $mysqli->query($sql)){
    if($result->num_rows > 0){
      echo "List of all campuses (including the name of the TVET provider) that did never offer a specific profession (let's say 'Welding', identified by the primary key 4).";;
        echo "<table>";
            echo "<tr>";
                echo "<th>Student</th>";
                echo "<th>Year</th>";
